...
const FeaturedPack = () => {
  const packFeatures = [
    { icon: Shield, text: "Assurance Sérénité+ (franchise 500 CHF)" },
    { icon: Truck, text: "Diable Pro inclus" },
    { icon: Package, text: "Kit de protection (sangles & couvertures)" },
  ];
