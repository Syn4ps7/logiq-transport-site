...
const Hero = () => {
  const features = [
    { icon: Zap, text: "Réservation 60 sec" },
    { icon: Clock, text: "Flotte 2025" },
    { icon: Shield, text: "Standard Suisse" },
  ];
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Louez votre utilitaire LogIQ en 60 secondes. Flotte neuve, gestion 100% digitale, standard suisse.
          </motion.p>
        ...
        >
          <div className="max-w-5xl mx-auto rounded-lg overflow-hidden relative">
            ...
            <img 
              src={heroVan} 
              alt="Utilitaire LogIQ Transport - Flotte premium 2025" 
